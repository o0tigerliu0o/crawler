...
import (
	...
	// git reset --hard 581912207615bc10f6e32ca5e1af9dd2f7ffa8b2
...
var (
	...
	xici  string = "https://list.proxylistplus.com/Fresh-HTTP-Proxy-List-1"
	ipMap        = make(map[string]string, PAGE)
)
